switch(type) {
	...
	case 3:
		...
		draw_sprite_ext( sbg_forest_new_extra,0,background_max_x,    room_height-430+background_max_y-128, 1, 1, 0, c_dkgray, 0.2 );
		draw_sprite_ext( sbg_forest_new_extra,0,background_max_x+666,room_height-430+background_max_y-128, 1, 1, 0, c_dkgray, 0.2 );
